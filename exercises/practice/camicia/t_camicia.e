...
test_equal("two cards, one trick",
    { {"status", "finished"}, {"cards", 2}, {"tricks", 1} },
    simulateGame( {"2"}, {"3"}))

test_equal("three cards, one trick",
    { {"status", "finished"}, {"cards", 3}, {"tricks", 1} },
    simulateGame( {"2", "4"}, {"3"}))

test_equal("four cards, one trick",
    { {"status", "finished"}, {"cards", 4}, {"tricks", 1} },
    simulateGame( {"2", "4"}, {"3", "5", "6"}))

test_equal("the ace reigns supreme",
    { {"status", "finished"}, {"cards", 7}, {"tricks", 1} },
    simulateGame( {"2", "A"}, {"3", "4", "5", "6", "7"}))

test_equal("the king beats ace",
    { {"status", "finished"}, {"cards", 7}, {"tricks", 1} },
    simulateGame( {"2", "A"}, {"3", "4", "5", "6", "K"}))

test_equal("the queen seduces the king",
    { {"status", "finished"}, {"cards", 10}, {"tricks", 1} },
    simulateGame( {"2", "A", "7", "8", "Q"}, {"3", "4", "5", "6", "K"}))

test_equal("the jack betrays the queen",
    { {"status", "finished"}, {"cards", 12}, {"tricks", 1} },
    simulateGame( {"2", "A", "7", "8", "Q"}, {"3", "4", "5", "6", "K", "9", "J"}))

test_equal("the 10 just wants to put on a show",
    { {"status", "finished"}, {"cards", 13}, {"tricks", 1} },
    simulateGame( {"2", "A", "7", "8", "Q", "10"}, {"3", "4", "5", "6", "K", "9", "J"}))

test_equal("simple loop with decks of 3 cards",
    { {"status", "loop"}, {"cards", 8}, {"tricks", 3} },
    simulateGame( {"J", "2", "3"}, {"4", "J", "5"}))

test_equal("the story is starting to get a bit complicated",
...
test_equal("two tricks",
    { {"status", "finished"}, {"cards", 5}, {"tricks", 2} },
    simulateGame( {"J"}, {"3", "J"}))

test_equal("more tricks",
    { {"status", "finished"}, {"cards", 12}, {"tricks", 4} },
    simulateGame( {"J", "2", "4"}, {"3", "J", "A"}))

test_equal("simple loop with decks of 4 cards",
    { {"status", "loop"}, {"cards", 16}, {"tricks", 4} },
    simulateGame( {"2", "3", "J", "6"}, {"K", "5", "J", "7"}))

test_equal("easy card combination",
...
test_equal("easy card combination, inverted decks",
    { {"status", "finished"}, {"cards", 40}, {"tricks", 4} },
    simulateGame( {
...
test_equal("Casella 2024, first infinite game found",
